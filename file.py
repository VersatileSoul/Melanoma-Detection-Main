...
def detectStreaks(img, cnt):
    ...
    result = cv2.bitwise_and(img, img, mask=maskSmall);
    ...
    if(allArea > 0):
        ...
        number_of_white_pix = np.sum(invert == 255)
...
def detectFeatures(file):
    try:
        ...
        print("Main Loop",e)
    filename = r'C:\Users\AJAY\Desktop\melanoma-diagnosis-analysis-main\Detection of Melanoma using Dermoscopic Feature Extraction and Analysis\finalized_model.pkl'
